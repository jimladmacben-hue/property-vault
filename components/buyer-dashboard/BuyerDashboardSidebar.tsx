...
const navSections = [
  {
    ...
    items: [
      ...
      {
        label: "Saved Properties", href: "/buyer-dashboard/saved",
      ...
      {
        label: "My Enquiries", href: "/buyer-dashboard/enquiries",
      ...
      {
        label: "Search Alerts", href: "/buyer-dashboard/alerts",
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Settings", href: "/buyer-dashboard/settings",
        badge: null,
      ...
      <div className="px-6 py-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gray-500 overflow-hidden flex-shrink-0">
            ...
            <img src="/images/agent-tunde.jpg" alt="buyer" className="w-full h-full object-cover"
              onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />
          </div>
          <div className="min-w-0">
            <p className="text-white text-sm font-bold truncate">Tunde Kehinde</p>
            <p className="text-white/40 text-xs truncate">Verified Buyer</p>
          </div>
        </div>
      </div>
