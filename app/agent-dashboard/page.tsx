      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 bg-white rounded-2xl border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-1">
            ...
            <Link href="/agent-dashboard/enquiries" className="text-xs font-bold text-[#1a1f3c] border border-gray-200 px-3 py-1.5 rounded-full hover:border-[#1a1f3c] transition-colors text-center">
              View all
            </Link>
          </div>
